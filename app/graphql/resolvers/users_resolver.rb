...
module Resolvers
  class UsersResolver < BaseResolver
    ...
    argument :created_after, GraphQL::Types::ISO8601Date, required: false, description: "Show users created after this date"
    argument :created_before, GraphQL::Types::ISO8601Date, required: false, description: "Show users created before this date"
