...
ActiveRecord::Schema[8.0].define(version: 2026_05_19_000003) do
  ...
  create_table "password_reset_tokens", force: :cascade do |t|
    ...
    t.index ["user_id", "used", "expires_at"], name: "index_reset_tokens_on_user_status"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["locked_until"], name: "index_users_on_locked_until", where: "(locked_until IS NOT NULL)"
